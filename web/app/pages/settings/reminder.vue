...
<i18n lang="json">
{
  "en": {
    ...
    "info": {
      ...
      "p3": "If you don't click a link in these emails for 3 days in a row, your daily reminder will be automatically disabled to make sure we're not sending you unwanted emails."
    },
    "form": {
  ...
  "de": {
    ...
    "info": {
      ...
      "p3": "Wenn Sie 3 Tage in Folge keinen Link in diesen E-Mails anklicken, wird Ihre tägliche Erinnerung automatisch deaktiviert, damit wir Ihnen keine unerwünschten E-Mails senden."
    },
    "form": {
  ...
  "es": {
    ...
    "info": {
      ...
      "p3": "Si no hace clic en ningún enlace de estos correos electrónicos durante 3 días seguidos, su recordatorio diario se desactivará automáticamente para asegurarnos de no enviarle correos electrónicos no deseados."
    },
    "form": {
  ...
  "fr": {
    ...
    "info": {
      ...
      "p3": "Si vous ne cliquez sur aucun lien de ces emails pendant 3 jours consécutifs, votre rappel quotidien sera automatiquement désactivé afin de ne pas vous envoyer d'emails indésirables."
    },
    "form": {
  ...
  "ko": {
    ...
    "info": {
      ...
      "p3": "이 이메일의 링크를 3일 연속 클릭하지 않으면, 원치 않는 이메일을 보내지 않도록 매일 알림이 자동으로 비활성화됩니다."
    },
    "form": {
  ...
  "pt": {
    ...
    "info": {
      ...
      "p3": "Se você não clicar em nenhum link nesses e-mails por 3 dias seguidos, seu lembrete diário será desativado automaticamente para garantir que não enviemos e-mails indesejados."
    },
    "form": {
  ...
  "uk": {
    ...
    "info": {
      ...
      "p3": "Якщо ви не натиснете жодне посилання в цих листах протягом 3 днів поспіль, ваше щоденне нагадування буде автоматично вимкнено, щоб ми не надсилали вам небажані листи."
    },
    "form": {
