...
og:
  title: My Bible Log - Free Bible Reading Tracker
  description: Track your Bible reading at your own pace with My Bible Log. Set daily goals, take notes, and make progress toward reading the entire Bible. Free, no ads, no subscriptions.
ld_json:
  name: My Bible Log
  description: A free online Bible reading tracker that helps you track and organize your Bible reading
---

<content-page-hero
  title="My Bible Log"
  subtitle="Read the whole Bible — your way."
  description="Track your Bible reading at your own pace, following <em>your</em> plan. My Bible Log is a <strong style='color: var(--primary-color);'>free Bible reading tracker</strong> that helps you see what you've read, stay consistent, and make progress toward reading the entire Bible."
...
description: >-
  Most Bible reading plans tell you <em>what</em> to read and <em>when</em>. <strong>My Bible Log works differently.</strong> You simply log what you've already read — from sermons, devotionals, small groups, or personal study — and it all counts toward your progress.
list:
  - No rigid schedules
  - No guilt if you miss a day
  - All your reading counts
reverse: false
---
::
...
list:
  - Read a little or a lot — it's up to you
  - See your progress update with every log entry
  - Reading ~86 verses a day means you'll finish the Bible in a year
button-text: Get Started Free
...
list:
  - See which chapters you've read
  - View progress for each book and the entire Bible
  - Quickly spot unread sections
reverse: true
---
::
...
list:
  - Edit or review any log entry
  - Gold stars show days you met your goal
...
list:
  ...
  - Install it as an app on your phone, tablet, or desktop
  - No ads. Ever.
  - Free to use
button-text: Get Started Free
button-destination: /register
