...
const locales: Locales = {
  en: {
    ...
    api_error: {
      ...
      new_email_required: 'A new email address is required',
      new_email_invalid: 'Please enter a valid email address',
      new_email_unchanged: 'New email cannot be the same as current email',
  ...
  de: {
    ...
    api_error: {
      ...
      new_email_required: 'Eine neue Email-Adresse ist erforderlich',
      new_email_invalid: 'Bitte geben Sie eine gültige Email-Adresse ein',
      new_email_unchanged: 'Die neue Email kann nicht die gleiche wie die aktuelle Email sein',
  ...
  es: {
    ...
    api_error: {
      ...
      new_email_required: 'Se requiere una nueva dirección de correo electrónico',
      new_email_invalid: 'Por favor ingrese una dirección de correo electrónico válida',
      new_email_unchanged: 'El nuevo correo electrónico no puede ser el mismo que el correo electrónico actual',
  ...
  fr: {
    ...
    api_error: {
      ...
      new_email_required: 'Une nouvelle adresse email est requise',
      new_email_invalid: 'Veuillez saisir une adresse email valide',
      new_email_unchanged: 'Le nouvel email ne peut pas être le même que l\'email actuel',
  ...
  ko: {
    ...
    api_error: {
      ...
      new_email_required: '새 이메일 주소를 입력해 주세요',
      new_email_invalid: '올바른 이메일 주소를 입력해 주세요',
      new_email_unchanged: '새로운 이메일 주소는 현재 이메일 주소와 달라야 합니다',
  ...
  pt: {
    ...
    api_error: {
      ...
      new_email_required: 'É necessário um novo endereço de email',
      new_email_invalid: 'Por favor, insira um endereço de email válido',
      new_email_unchanged: 'O novo email não pode ser o mesmo que o email atual',
  ...
  uk: {
    ...
    api_error: {
      ...
      new_email_required: 'Потрібна нова електронна адреса',
      new_email_invalid: 'Будь ласка, введіть дійсну електронну адресу',
      new_email_unchanged: 'Нова електронна пошта не може бути такою ж, як поточна електронна пошта',
