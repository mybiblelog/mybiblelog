...
<content-fifty-fifty
  ...
  :list="['Sin horarios rígidos', 'Sin culpa si te pierdes un día', 'Toda tu lectura cuenta']"
...
<content-fifty-fifty
  ...
  :list="['Lee un poco o mucho — tú decides', 'Ve tu progreso actualizarse con cada entrada de registro', 'Leer ~86 versículos al día significa que terminarás la Biblia en un año']"
  button-text="Comenzar gratis"
...
<content-fifty-fifty
  ...
  :list="['Edita o revisa cualquier entrada de registro', 'Las estrellas doradas muestran los días en que alcanzaste tu objetivo', 'Exporta o importa tu registro de lectura en cualquier momento']"
  button-text="Comenzar gratis"
  button-destination="/register"
  :reverse="false"></content-fifty-fifty>
