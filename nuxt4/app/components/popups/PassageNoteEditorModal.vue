...
<i18n lang="json">
{
  ...
  "de": { "new_note": "Neue Notiz", "edit_note": "Notiz bearbeiten", "passages": "Passagen", "add_passage": "Passage hinzufügen", "done": "Fertig", "cancel": "Abbrechen", "remove": "Entfernen", "no_passages": "Noch keine Passagen hinzugefügt", "content": "Inhalt", "characters": "Zeichen", "tags": "Tags", "manage_tags": "Tags auswählen", "no_tags_selected": "Keine Tags ausgewählt", "loading": "Laden", "save": "Speichern", "add": "Speichern", "close": "Schließen", "could_not_save": "Die Notiz konnte nicht gespeichert werden.", "are_you_sure": "Sind Sie sicher, dass Sie diese Passage entfernen möchten?" },
  "es": { "new_note": "Nueva nota", "edit_note": "Editar nota", "passages": "Pasajes", "add_passage": "Añadir Pasaje", "done": "Hecho", "cancel": "Cancelar", "remove": "Eliminar", "no_passages": "No hay pasajes", "content": "Contenido", "characters": "caracteres", "tags": "Etiquetas", "manage_tags": "Elegir etiquetas", "no_tags_selected": "No hay etiquetas seleccionadas", "loading": "Cargando", "save": "Guardar", "add": "Guardar", "close": "Cerrar", "could_not_save": "La nota no se pudo guardar.", "are_you_sure": "¿Estás seguro de que quieres eliminar este pasaje?" },
  "fr": { "new_note": "Nouvelle note", "edit_note": "Modifier la note", "passages": "Passages", "add_passage": "Ajouter un passage", "done": "Terminé", "cancel": "Annuler", "remove": "Supprimer", "no_passages": "Aucun passage", "content": "Contenu", "characters": "caractères", "tags": "Tags", "manage_tags": "Choisir des tags", "no_tags_selected": "Aucune étiquette sélectionnée", "loading": "Chargement", "save": "Sauvegarder", "add": "Sauvegarder", "close": "Fermer", "could_not_save": "La note n'a pas pu être sauvegardée.", "are_you_sure": "Êtes-vous sûr de vouloir supprimer ce passage ?" },
  "ko": { "new_note": "새 노트", "edit_note": "노트 편집", "passages": "구절", "add_passage": "구절 추가", "done": "완료", "cancel": "취소", "remove": "삭제", "no_passages": "아직 추가된 구절이 없습니다", "content": "내용", "characters": "자", "tags": "태그", "manage_tags": "태그 선택", "no_tags_selected": "선택된 태그 없음", "loading": "불러오는 중", "save": "저장", "add": "저장", "close": "닫기", "could_not_save": "노트를 저장할 수 없습니다.", "are_you_sure": "해당 구절을 삭제할까요?" },
  "pt": { "new_note": "Nova nota", "edit_note": "Editar nota", "passages": "Passagens", "add_passage": "Adicionar Passagem", "done": "Concluído", "cancel": "Cancelar", "remove": "Remover", "no_passages": "Nenhuma passagem adicionada ainda", "content": "Conteúdo", "characters": "caracteres", "tags": "Tags", "manage_tags": "Escolher tags", "no_tags_selected": "Nenhuma tag selecionada", "loading": "Carregando", "save": "Salvar", "add": "Salvar", "close": "Fechar", "could_not_save": "A nota não pôde ser salva.", "are_you_sure": "Tem certeza de que deseja remover esta passagem?" },
  "uk": { "new_note": "Нова нотатка", "edit_note": "Редагувати нотатку", "passages": "Пасажі", "add_passage": "Додати пасаж", "done": "Готово", "cancel": "Скасувати", "remove": "Видалити", "no_passages": "Немає пасажів", "content": "Зміст", "characters": "символи", "tags": "Теги", "manage_tags": "Вибрати теги", "no_tags_selected": "Теги не вибрані", "loading": "Завантаження", "save": "Зберегти", "add": "Зберегти", "close": "Закрити", "could_not_save": "Не вдалося зберегти нотатку.", "are_you_sure": "Ви впевнені, що хочете видалити цей пасаж?" }
}
</i18n>
