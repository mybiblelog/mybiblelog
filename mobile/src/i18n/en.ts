export const en = {
  ...
  insights_tab_activity: "Activity",
  insights_tab_books: "Books",
  insights_tab_frequency: "Frequency",
  insights_tab_trend: "Trend",
  insights_loading: "Loading your reading history…",
  insights_description_activity:
    "Each square is a day over the past year. Darker squares mean more verses read.",
  insights_description_books: "How recently you last read from each book of the Bible.",
  insights_description_frequency: "How much you've read from each book within a timeframe.",
  insights_description_trend: "Verses read each day over your chosen time window.",

  insights_heatmap_less: "Less",
  insights_heatmap_more: "More",
  insights_heatmap_verses_read_one: "%{count} verse read",
  insights_heatmap_verses_read_other: "%{count} verses read",
  insights_heatmap_no_activity: "No verses read",

  insights_books_sort_label: "Sort by",
  insights_books_sort_bible_order: "Bible order",
  insights_books_sort_alphabetical: "Alphabetical",
  insights_books_sort_most_recent: "Most recent",
  insights_books_sort_least_recent: "Least recent",
  insights_books_never_read: "Never read",
  insights_books_today: "Today",
  insights_books_yesterday: "Yesterday",
  insights_books_days_ago_one: "1 day ago",
  insights_books_days_ago_other: "%{count} days ago",
  insights_books_weeks_ago_one: "1 week ago",
  insights_books_weeks_ago_other: "%{count} weeks ago",
  insights_books_months_ago_one: "1 month ago",
  insights_books_months_ago_other: "%{count} months ago",
  insights_books_years_ago_one: "1 year ago",
  insights_books_years_ago_other: "%{count} years ago",
  insights_books_timeframe_label: "Timeframe",
  insights_books_last_n_days: "Last %{count} days",
  insights_books_all_time: "All time",
  insights_books_testament_label: "Books",
  insights_books_whole_bible: "Whole Bible",
  insights_books_old_testament: "Old Testament",
  insights_books_new_testament: "New Testament",
  insights_books_less_recent: "Less recent",
  insights_books_more_recent: "More recent",
  insights_books_not_read: "Not read",
  insights_books_not_read_in_timeframe: "Not read in timeframe",

  insights_frequency_timeframe_label: "Timeframe",
  insights_frequency_last_n_days: "Last %{count} days",
  insights_frequency_metric_label: "Metric",
  insights_frequency_metric_raw: "Verse counts",
  insights_frequency_metric_proportional: "Proportional",
  insights_frequency_sort_label: "Sort by",
  insights_frequency_sort_bible_order: "Bible order",
  insights_frequency_sort_alphabetical: "Alphabetical",
  insights_frequency_sort_most_read: "Most read",
  insights_frequency_sort_least_read: "Least read",

  insights_trend_window_label: "Time window",
  insights_trend_last_n_days: "Last %{count} days",
  insights_trend_chart_label: "Verses read per day",
  ...
  settings_section_insights: "Insights",
  settings_section_insights_subtitle: "Your reading activity and trends",
  ...
  note_menu_title_date: "Note from %{date}",
